 ...
 * @LastEditTime: 2022-12-03 17:11:37
 * @LastEditors: ayiyiyo
 * @Description:
 * @FilePath: \lc_-sys_-platform\src\components\common-panel\Index.vue
-->
<template>
  <q-card class="common-panel">
    ...
    <q-separator v-if="separatorOpts.show" v-bind="separatorOpts" class="separatorLine" />
    <div class="content">
      <slot></slot>
    </div>
  </q-card>
