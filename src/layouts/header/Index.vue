 ...
 * @LastEditTime: 2023-07-19 19:58:12
 * @LastEditors: zouyaoji 370681295@qq.com
 * @Description:
 * @FilePath: \vue-map-demo\src\layouts\header\Index.vue
-->
<template>
  <q-toolbar class="main-header">
    ...
    <q-avatar class="cursor-pointer" @click="onToggleLeftDrawer">
      <!-- <img src="../../assets/images/logo_hd.png" /> -->
      <q-icon name="view_list" size="32px"></q-icon>
    </q-avatar>

    <q-toolbar-title
      :shrink="true"
      style="width: 500px; font-weight: 400; font-family: YouSheBiaoTiYuan; font-size: 30px"
    >
      {{ title }}
    </q-toolbar-title>
